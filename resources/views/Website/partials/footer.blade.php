<footer class="bg-slate-800">
    <div class="mx-auto max-w-screen-xl pb-6 pt-10 md:py-10 sm:px-6 lg:px-16">
        <div
            class="w-full grid grid-cols-1 md:grid-cols-12 px-6 md:py-8 md:px-0 gap-8"
        >
            <div class="md:col-span-5">
                <div class="flex justify-center sm:justify-start">
                    <h2 class="mr-3 text-lg text-red-500 font-semibold">
                        Observatório de feminicídio
                    </h2>
                </div>

                <p
                    class="mt-6 leading-relaxed text-sm text-justify text-white dark:text-gray-400 max-w-5xl"
                >
                    Órgão composto por OSC`s, criado através do Fórum Regional
                    Centro de Género – FRCG que nasceu do grupo multissectorial
                    da província de Sofala no quarto trimestre de 2023 para
                    observar, monitorar e refletir sobre ações de resposta ao
                    feminicídio estabelecendo a necessária interface com as
                    instituições públicas e privadas, e outras instituições
                    parceiras que se propõem a colaborar.
                </p>
            </div>
            <div class="md:col-span-7 grid grid-cols-10 gap-8 pb-4">
                <div class="col-span-3">
                    <p class="text-lg font-medium text-red-500 dark:text-white">
                        Links
                    </p>
                    ...
                    <nav aria-label="Footer Navigation Nav" class="mt-8">
                        <ul class="space-y-4 text-sm">
                            <li>
                                <a
                                    href="{{ route("welcome") }}"
                                    class="hover:underline text-white transition hover:text-white/75 dark:text-white dark:hover:text-white/75"
                                >
                                    Início
                                </a>
                            </li>
                    ...
                    <ul class="mt-8 space-y-4 text-sm">
                        <li>
                            <a
                                ...
                                href="mailto:ampdcassociacao@gmail.com"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="h-5 w-5 shrink-0 text-red-400 dark:text-white"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                    stroke-width="2"
                                ...
                                <span
                                    class="flex-1 text-white dark:text-gray-300 line-clamp-2"
                                >
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span
                                    class="flex-1 text-white dark:text-gray-300 break-words line-clamp-1"
                                >
                                    (+258) 87 160 7144
                                </span>
                            </a>
                        ...
                        >
                            ...
                            <address
                                class="-mt-0.5 flex-1 not-italic text-white dark:text-gray-300 line-clamp-1"
                            >
