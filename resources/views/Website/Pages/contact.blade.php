...
@section("content")
    <div class="h-96 ml-0">
        <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1915.845016318067!2d34.83570037740713!3d-19.831709653359095!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1f2a6bb13c5702d7%3A0xf9831dfaf4d60cee!2sAMPDC%20Associa%C3%A7%C3%A3o%20de%20Mulheres%20Para%20Promo%C3%A7%C3%A3o%20de%20Desenvolvimento%20Comunit%C3%A1rio!5e1!3m2!1sen!2smz!4v1720964648404!5m2!1sen!2smz"
            style="border: 0"
    ...
    <section class="w-full grid grid-cols-10">
        <div
            class="hidden col-span-10 md:col-span-4 md:grid transition-transform bg-red-500 p-20 text-white font-semibold"
        >
            <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                    <h4 class="text-white mb-1 text-xl font-bold uppercase">
                        Localização
                    </h4>
        ...
        <div class="col-span-10 md:col-span-6 px-6 py-16 md:p-20 bg-red-50">
            @if(session('message_success'))
                <div id="alert-border-3" class="flex p-4 mb-4 text-white border-t-4 border-green-900 bg-green-600 " role="alert">
            ...
            @elseif(session('message_error'))
                <div id="alert-border-2" class="flex p-4 mb-4 text-white border-t-4 border-red-800 bg-red-600 dark:text-red-400 dark:bg-gray-800 dark:border-red-800" role="alert">
                    <svg class="flex-shrink-0 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
                    <div class="ml-3 text-sm font-medium">
            ...
            <form action="{{ route("contact.message") }}" method="post">
                @csrf
                <div
                    class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-2 justify-items-stretch"
                >
                    <div class="mb-2">
                        <label for="nome_do_cliente">
                            Teu nome
                            <strong class="-order-2 text-red-500">*</strong>
                        </label>
                        <input
                            type="text"
                            name="name"
                            id="name"
                            class="h-10 border mt-1 focus:ring-1 focus:ring-red-500 border-red-500 focus:border-red-500 rounded-sm p-6 px-4 w-full bg-red-50"
                            value="{{old('name')}}"
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            name="email"
                            id="email"
                            class="h-10 border mt-1 rounded-sm p-6 px-4 w-full bg-red-50 focus:ring-1 focus:ring-red-500 border-red-500 focus:border-red-500"
                            value="{{old('email')}}"
                    ...
                    <div class="md:col-span-2 mb-2">
                        ...
                        <input
                            ...
                            name="contact"
                            id="contacto"
                            class="h-10 border mt-1 rounded-sm p-6 px-4 w-full bg-red-50 focus:ring-1 border-red-500 focus:ring-red-500 focus:border-red-500"
                            value="{{ old('contact') }}"
                    ...
                    <div class="md:col-span-2 mb-2">
                        ...
                        <div
                            class="flex border border-red-200 items-center mt-1"
                        >
                            <textarea
                                name="message"
                                id="message"
                                cols="10"
                                rows="5"
                                class="px-4 appearance-none outline-none text-gray-800 w-full bg-transparent focus:ring-1 border-red-500 focus:ring-red-500 focus:border-red-500 rounded-sm"
                    ...
                    <div class="md:col-span-2 text-right mb-2">
                        <div class="">
                            <button
                                type="submit"
                                class="bg-red-500 hover:ring-1 hover:ring-red-500 text-white font-bold py-3 px-4 rounded-sm w-full"
                            >
                                Enviar mensagem
                            </button>
                        </div>
