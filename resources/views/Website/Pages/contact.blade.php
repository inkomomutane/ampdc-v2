    ...
    <section class="w-full grid grid-cols-10">
        ...
        <div class="col-span-10 md:col-span-6 px-6 py-16 md:p-20 bg-red-50">
            @if (session("message_success"))
                <div
                    id="alert-border-3"
                    class="flex p-4 mb-4 text-white border-t-4 border-green-900 bg-green-600"
                    role="alert"
                >
                    <svg
            ...
            @elseif (session("message_error"))
                <div
                    id="alert-border-2"
                    class="flex p-4 mb-4 text-white border-t-4 border-red-800 bg-red-600 dark:text-red-400 dark:bg-gray-800 dark:border-red-800"
                    role="alert"
                >
                    <svg
                        class="flex-shrink-0 w-5 h-5"
