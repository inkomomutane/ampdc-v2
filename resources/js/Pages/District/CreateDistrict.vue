...
const addDistrict = ref(false);
const nameInput = ref();

const addDistrictTrigger = () => {
    addDistrict.value = true;
};

const closeCreateDistrictModal = () => {
    addDistrict.value = false;
};
    ...
    <Modal :show="addDistrict" @close="closeCreateDistrictModal">
        <div class="relative bg-white rounded shadow dark:bg-gray-700">
            <button
                ...
                @click="closeCreateDistrictModal"
            >
                <svg
                    aria-hidden="true"
                    class="w-5 h-5"
