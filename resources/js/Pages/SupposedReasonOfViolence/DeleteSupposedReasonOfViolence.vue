...
const form = useForm({
    id: props.supposedReasonOfViolence.id,
});

const deleteSupposedReasonOfViolence = () => {
    form.delete(
        route("supposedReasonOfViolence.delete", {
            supposedReasonOfViolence: props.supposedReasonOfViolence.id,
        }),
        {
            preserveScroll: true,
            onSuccess: () => {
    ...
    <Modal :show="props.openModal" @close="props.close">
        <div class="relative bg-white rounded shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                <h1 class="flex">Deseja excluir esse motivo de violência?</h1>
                <form class="space-y-6" @submit.prevent="deleteSupposedReasonOfViolence">
                    <button
                        type="submit"
                    ...
                    >
                        <span>Excluir esse motivo de violência.</span>
                    </button>
                </form>
            </div>
        </div>
