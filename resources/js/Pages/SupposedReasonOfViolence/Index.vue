...
const props = defineProps({
    supposedReasonOfViolences: {
        type: Object as PropType<SupposedReasonOfViolences>,
        required: true,
    },
    search: String,
...
watch(
    () => props.supposedReasonOfViolences.links,
    (value) => {
        links.value = value;
    },
);
...
watch(searchTerm, (value) => {
    router.visit(
        route("supposedReasonOfViolence.list", {
            search: value ?? "",
        }),
        {
            only: ["supposedReasonOfViolences"],
            replace: false,
            preserveState: true,
        },
    );
...
function closeEditSupposedReasonOfViolenceModal() {
    editingSupposedReasonOfViolence.value = null;
...
function closeDeleteSupposedReasonOfViolenceModal() {
    deletingSupposedReasonOfViolence.value = null;
    deletingSupposedReasonOfViolenceTrigger.value = false;
}
</script>
...
<template>
    ...
    <AuthenticatedLayout>
        <template v-slot:content>
            <div class="mx-auto max-w-screen-xl">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <CreateSupposedReasonOfViolence />
                        </div>
                    </div>
                                ...
                                >
                                    ...
                                    <td class="px-4 py-3 w-32">
                                        <button
                                            ...
                                            type="button"
                                            @click="
                                                openEditSupposedReasonOfViolenceModal(
                                    ...
                                    <td class="px-4 py-3 justify-end w-32">
                                        <button
                                            ...
                                            type="button"
                                            @click="
                                                openDeleteSupposedReasonOfViolenceModal(
                                                    supposedReasonOfViolence,
                                                )
                                            "
                                        >
                    ...
                    >
                        ...
                        >
                            ...
                            <span
                                class="font-semibold text-gray-900 dark:text-white"
                            >
                                {{ supposedReasonOfViolences.meta.total }}</span
                            >
                        </span>
            ...
            <EditSupposedReasonOfViolence
                v-if="editingSupposedReasonOfViolence"
                :close="closeEditSupposedReasonOfViolenceModal"
                :openModal="editingSupposedReasonOfViolenceTrigger"
                :supposedReasonOfViolence="editingSupposedReasonOfViolence"
            />
            <DeleteSupposedReasonOfViolence
                v-if="deletingSupposedReasonOfViolence"
                :close="closeDeleteSupposedReasonOfViolenceModal"
                :openModal="deletingSupposedReasonOfViolenceTrigger"
                :supposedReasonOfViolence="deletingSupposedReasonOfViolence"
            />
        </template>
    </AuthenticatedLayout>
</template>
