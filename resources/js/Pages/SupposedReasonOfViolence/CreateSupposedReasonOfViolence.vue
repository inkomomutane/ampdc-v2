...
const addSupposedReasonOfViolence = ref(false);
const nameInput = ref();

const addSupposedReasonOfViolenceTrigger = () => {
    addSupposedReasonOfViolence.value = true;
};

const closeCreateSupposedReasonOfViolenceModal = () => {
    addSupposedReasonOfViolence.value = false;
    form.reset();
};
...
const createSupposedReasonOfViolence = () => {
    form.post(route("supposedReasonOfViolence.store"), {
        preserveScroll: true,
        onSuccess: () => closeCreateSupposedReasonOfViolenceModal(),
...
<template>
    <button
        ...
        type="button"
        @click="addSupposedReasonOfViolenceTrigger"
    >
        <svg
            height="20"
            viewBox="0 0 24 24"
    ...
    <Modal :show="addSupposedReasonOfViolence" @close="closeCreateSupposedReasonOfViolenceModal">
        <div class="relative bg-white rounded shadow dark:bg-gray-700">
            <button
                ...
                type="button"
                @click="closeCreateSupposedReasonOfViolenceModal"
            >
                <svg
                    aria-hidden="true"
                    class="w-5 h-5"
                    ...
                    <div class="grid grid-cols-1 gap-2">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Motivo de violência"
                                type="text"
                            />
