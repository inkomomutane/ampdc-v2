        ...
        <template v-slot:banner>
            <div class="mx-auto max-w-screen-xl">
                ...
                <div class="relative overflow-hidden">
                    <div
                        class="max-w-screen-xl relative bg-indigo-200 dark:bg-indigo-500 p-4 sm:p-6 rounded-sm overflow-hidden"
                    >
                        <!-- Background illustration -->
                        <div
                            class="absolute right-0 top-0 pointer-events-none hidden xl:block"
                            aria-hidden="true"
                        >
                            <svg
                                width="319"
                        ...
                        <div class="relative">
                            <h1
                                class="text-xl md:text-2xl text-slate-700 dark:text-slate-100 font-bold mb-1"
                            >
                                Estatísticas da base de dados
                            </h1>
                            <p class="dark:text-indigo-200 hidden">
            ...
            <div class="mx-auto max-w-screen-xl mt-4">
                ...
                <div class="relative overflow-hidden">
                    ...
                    <div class="grid sm:grid-cols-2 xl:grid-cols-3 my-6 gap-6">
                        ...
                        />
                        <DashboardCardData
                            :value="forwardedCasesCount"
                            label="Casos encaminhados"
                        />
                        <DashboardCardData
                            :value="receivedCasesCount"
