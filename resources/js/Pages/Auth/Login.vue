...
<template>
    <section class="bg-rose-50 min-h-screen grid grid-cols-1 md:grid-cols-5">
        <div
            class="relative overflow-hidden col-span-2 hidden md:flex bg-gradient-to-t from-orange-500 to-rose-500 justify-around items-center"
        >
            <div class="px-16">
                <h1
                ...
                ></div>
                <div
                    class="absolute border-orange-200 -bottom-40 -left-20 w-80 h-80 border-4 rounded-full border-opacity-30 border-t-8"
                ></div>
            </div>
        </div>
        <section
        ...
        >
            ...
            >
                ...
                >
                    <div
                        class="min-w-full rounded-sm dark:border md:mt-0 xl:p-0 dark:bg-gray-800 dark:border-gray-700"
                    >
                        <div
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="••••••••••••••••"
                                        class="border border-rose-300 text-gray-900 sm:text-sm rounded-sm focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        required
                                    />
                                    <InputError
                                        class="mt-2"
