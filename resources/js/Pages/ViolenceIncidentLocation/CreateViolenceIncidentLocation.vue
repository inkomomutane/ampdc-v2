...
const addViolenceIncidentLocation = ref(false);
const nameInput = ref();

const addViolenceIncidentLocationTrigger = () => {
    addViolenceIncidentLocation.value = true;
};

const closeCreateViolenceIncidentLocationModal = () => {
    addViolenceIncidentLocation.value = false;
    form.reset();
};
...
const createViolenceIncidentLocation = () => {
    form.post(route("violenceIncidentLocation.store"), {
        preserveScroll: true,
        onSuccess: () => closeCreateViolenceIncidentLocationModal(),
...
<template>
    <button
        ...
        type="button"
        @click="addViolenceIncidentLocationTrigger"
    >
        <svg
            height="20"
            viewBox="0 0 24 24"
    ...
    <Modal :show="addViolenceIncidentLocation" @close="closeCreateViolenceIncidentLocationModal">
        <div class="relative bg-white rounded shadow dark:bg-gray-700">
            <button
                ...
                type="button"
                @click="closeCreateViolenceIncidentLocationModal"
            >
                <svg
                    aria-hidden="true"
                    class="w-5 h-5"
