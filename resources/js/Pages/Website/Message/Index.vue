...
const showViewingMessage = (mail: App.Data.WebsiteMessageData) => {
    if (!mail.is_read) {
        axios
            ...
            .then(() => {
                router.reload({ only: ["website_messages", "mails"] });
            });
    }
...
<template>
    <Head title="Mensagens do website" />
    <AuthenticatedLayout>
                    ...
                    >
                        <button class="w-full text-left">
                            <li
                                ...
                                v-for="message in props.website_messages?.data"
                                :class="
                                    message.is_read
                ...
                >
                    ...
                    >
                        ...
                        <span
                            class="font-semibold text-gray-900 dark:text-white"
                        >
                            {{ website_messages?.meta.total }}</span
                        >
                    </span>
