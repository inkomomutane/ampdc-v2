            ...
            <div class="mx-auto max-w-screen-xl">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <a :href="route('export.victims.cases')"
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <p
                                        :class="{
                                            'bg-blue-600': !caseVictim.isTerminated,
                                            'bg-green-600': caseVictim.isTerminated,
                                        }"
                                        class="my-4 w-fit rounded-[2px]  p-1 px-4 text-sm font-semibold text-white"
                                    >
                                        {{ caseVictim.isTerminated ? 'Encerrado' : 'Em andamento' }}
                                    </p>
                                </td>
