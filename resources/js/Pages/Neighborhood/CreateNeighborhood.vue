...
import { DistrictData } from "@/types/generated";
...
const addNeighborhood = ref(false);
const nomeInput = ref();
const addNeighborhoodTrigger = () => {
    addNeighborhood.value = true;
};

const closeCreateNeighborhoodModal = () => {
    addNeighborhood.value = false;
};
...
<template>
    ...
    <Modal :show="addNeighborhood" @close="closeCreateNeighborhoodModal">
        <div class="relative bg-white rounded shadow dark:bg-gray-700">
            <button
                type="button"
                class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                @click="closeCreateNeighborhoodModal"
            >
                <svg
                    aria-hidden="true"
                    class="w-5 h-5"
            ...
            <div class="px-6 py-6 lg:px-8 h-full">
                ...
                <form class="space-y-6" @submit.prevent="createNeighborhood">
                    <div>
                        <label
                            for="nome"
