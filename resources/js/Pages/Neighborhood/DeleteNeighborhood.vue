...
import { NeighborhoodData } from "@/types/generated";
    ...
    <Modal :show="props.openModal" @close="props.close">
        <div class="relative bg-white rounded shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                >
                    Tem certeza que quer excluir esse bairro?
                </h3>
                <form class="space-y-6" @submit.prevent="deleteNeighborhood">
                    <button
                        type="submit"
