...
const props = defineProps({
    perpetrators: {
        type: Object as PropType<Perpetrators>,
        required: true,
    },
    search: String,
...
function closeEditPerpetratorModal() {
    editingPerpetrator.value = null;
...
function closeDeletePerpetratorModal() {
    deletingPerpetrator.value = null;
    deletingPerpetratorTrigger.value = false;
}
</script>
...
<template>
    ...
    <AuthenticatedLayout>
        <template v-slot:content>
                ...
                >
                    ...
                    <div class="overflow-x-auto">
                        ...
                        >
                            ...
                            <tbody>
                                <tr
                                    v-for="perpetrator in perpetrators.data"
                                    :key="perpetrator.id ?? undefined"
                    ...
                    >
                        ...
                        >
                            ...
                            <span
                                ...
                                >{{
                                    `${perpetrators.meta.from ?? 0}-${
                                        perpetrators.meta.to ?? 0
                                    }`
                                }}</span
                            >
                            of
            ...
            <EditPerpetrator
                v-if="editingPerpetrator"
                :close="closeEditPerpetratorModal"
                :openModal="editingPerpetratorTrigger"
                :perpetrator="editingPerpetrator"
            />
            <DeletePerpetrator
                v-if="deletingPerpetrator"
                :close="closeDeletePerpetratorModal"
                :openModal="deletingPerpetratorTrigger"
                :perpetrator="deletingPerpetrator"
            />
        </template>
    </AuthenticatedLayout>
</template>
