...
const form = useForm({
    id: props.perpetrator.id,
});

const deletePerpetrator = () => {
    form.delete(
        route("perpetrator.delete", {
            perpetrator: props.perpetrator.id,
        }),
        {
            preserveScroll: true,
            onSuccess: () => {
    ...
    <Modal :show="props.openModal" @close="props.close">
        <div class="relative bg-white rounded shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                <h1 class="flex">Deseja excluir esse perpetrador?</h1>
                <form class="space-y-6" @submit.prevent="deletePerpetrator">
                    <button
                        type="submit"
                    ...
                    >
                        <span>Excluir esse perpetrador.</span>
                    </button>
                </form>
            </div>
        </div>
